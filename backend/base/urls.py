...
urlpatterns = [
    ...
    path('create-social-project/', views.create_social_project, name="create-social-project"), #Implemented
    path('create-event/', views.create_event, name="create-event"), #Implemented
    path('create-donation/', views.create_donation, name="create-donation"), #----------------------------
    path('get-all-events/', views.get_all_events, name="get-all-events"), #Implemented
    path('get-all-projects/', views.get_all_projects, name="get-all-projects"), #Implemented
    ...
    path('stats/', views.stats, name="stats"), #Implemented
]
