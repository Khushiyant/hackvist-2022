        ...
        <>
            <div className="app_login h-screen flex flex-row-reverse">
                <div className="login_infoContainer bg-gradiant h-full text-white w-full p-16 flex flex-col justify-center align-start">
                    <h1 className="infoContainer_tagLine font-roboto-slab text-4xl font-semibold leading-tight tracking-wide">Lend A Hand</h1>
                    <h1 className="infoContainer_tagLine font-roboto-slab text-4xl font-semibold leading-tight tracking-wide">To Bring A Smile.</h1>
                ...
                <div className="login_loginFormContainer bg-alabaster h-full w-full flex flex-col justify-center items-start p-16">
                    ...
                    <form className="app_loginForm w-full mt-12 rounded-lg flex flex-col items-center gap-4" onSubmit={(event) => formSubmitHandler(event)}>
                        <div className="loginForm_formGroup bg-white w-full flex items-center gap-0 font-roboto outline outline-1 outline-[#545454]/30 hover:outline-[#545454]/60 focus:outline-[#545454] transition-all duration-400 rounded-sm">
                            ...
                            <input type="text" name="userName" id="userName" placeholder="Enter Your Full Name*" required="required" autoComplete='off' className="formGroup_input w-full p-2 focus:outline-none" />
                        </div>
                        <div className="loginForm_formGroup bg-white w-full flex items-center gap-0 font-roboto outline outline-1 outline-[#545454]/30 hover:outline-[#545454]/60 focus:outline-[#545454] transition-all duration-400 rounded-sm">
                            <span className="formGroup_groupIconContainer w-12 h-max grid place-content-center border-r-2 border-r-[#545454]/40 text-2xl text-[#545454]/60 transition-all duration-400">
                                <GrMail />
                            </span>
                            <input type="email" name="userEmail" id="userEmail" placeholder="Enter Your Email ID*" required="required" autoComplete='off' className="formGroup_input w-full p-2 focus:outline-none" />
                        </div>
                        <div className="loginForm_formGroup bg-white w-full flex items-center gap-0 font-roboto outline outline-1 outline-[#545454]/30 hover:outline-[#545454]/60 focus:outline-[#545454] transition-all duration-400 rounded-sm">
                            <span className="formGroup_groupIconContainer w-12 h-max grid place-content-center border-r-2 border-r-[#545454]/40 text-xl text-[#545454]/60 transition-all duration-400">
                                <FaPhoneAlt />
                            </span>
                            <input type="tel" name="userPhone" id="userPhone" placeholder="Enter Your Phone Number*" required="required" autoComplete='off' className="formGroup_input w-full p-2 focus:outline-none" />
                        </div>
                        <div className="loginForm_formGroup bg-white w-full flex items-center gap-0 font-roboto outline outline-1 outline-[#545454]/30 hover:outline-[#545454]/60 focus:outline-[#545454] transition-all duration-400 rounded-sm">
                            <span className="formGroup_groupIconContainer w-12 h-max grid place-content-center border-r-2 border-r-[#545454]/40 text-2xl text-[#545454]/60 transition-all duration-400">
                                <HiLink />
                            </span>
                            <input type="url" name="userProfileImg" id="userProfileImg" placeholder="Enter URL of Your Profile Image" autoComplete='off' className="formGroup_input w-full p-2 focus:outline-none" />
                        </div>
                        <div className="loginForm_formGroup bg-white w-full flex items-center gap-0 font-roboto outline outline-1 outline-[#545454]/30 hover:outline-[#545454]/60 focus:outline-[#545454] transition-all duration-400 rounded-sm">
                            <span className="formGroup_groupIconContainer w-12 h-max grid place-content-center border-r-2 border-r-[#545454]/40 text-2xl text-[#545454]/60 transition-all duration-400">
                                <GrList />
                            </span>
                            <select name="userType" id="userType" defaultValue="" required="required" className="formGroup_input w-full p-2 focus:outline-none">
                        ...
                        <div className="loginForm_formGroup bg-white w-full flex items-center gap-0 font-roboto outline outline-1 outline-[#545454]/30 hover:outline-[#545454]/60 focus:outline-[#545454] transition-all duration-400 rounded-sm">
                            ...
                            <input type="password" name="userPassword" id="userPassword" placeholder="Enter Password*" required="required" className="formGroup_input w-full p-2 focus:outline-none" />
                        </div>
                        <div className="loginForm_formGroup bg-white w-full flex items-center gap-0 font-roboto outline outline-1 outline-[#545454]/30 hover:outline-[#545454]/60 focus:outline-[#545454] transition-all duration-400 rounded-sm">
                            <span className="formGroup_groupIconContainer w-12 h-max grid place-content-center border-r-2 border-r-[#545454]/40 text-2xl text-[#545454]/60 transition-all duration-400">
                                <HiLockClosed />
                            </span>
                            <input type="password" name="userPassword" id="userPassword" placeholder="Confirm Password*" required="required" className="formGroup_input w-full p-2 focus:outline-none" />
                        </div>
